...
<body
  ...
  <div style="display: none;">A request to reset password was received from your Account</div>
  <div role="article" aria-roledescription="email" aria-label="Reset your Password" lang="en">
                  ...
                  <tr>
                    <td class="sm-px-24"
                      ...
                      <p style="margin: 0 0 24px;">
                        This is the password reset OTP you requested. Use it to reset your account password.
                      </p>
    ...
    const text = `
        Reset Password, You recently requested to reset your password for your account. Copy and paste it for reset password:
        ${otp}
